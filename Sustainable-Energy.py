...
# Loading the data
Energy_data = px.data.Energy_data()
#TiTle
 ...
 #################GDP Analysis (2020)######################
    ...
    with tab2:
        ...
        if menu == "Trends in Electricity Access and Renewable Energy Adoption by Entity":
            ...
            selected_country = st.selectbox("Select a Country", options=country_list, index=country_list.index('Afghanistan'))
            ...
            evolved_fig = px.line(Afga_df,
                                  ...
                                  title="Afghanistan: Evolution of Electricity Access, Renewable Energy over time")
